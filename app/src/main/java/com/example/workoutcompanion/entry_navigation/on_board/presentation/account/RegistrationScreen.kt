package com.example.workoutcompanion.entry_navigation.on_board.presentation.account
...
import com.example.workoutcompanion.entry_navigation.on_board.composables.TermsOfUseDialogue
    ...
    Scaffold(
        ...
        Column(
            ...
            Row(
                ...
                Text(if(termsState.isError()) "You must agree with he terms in order to continue" else "I agree with the Terms of Use" , color = contentColor)
